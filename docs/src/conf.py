...
# Get version info
with open(str(Path(__file__).parent.parent.parent.joinpath('src/pymodaq_femto/VERSION')), 'r') as fvers:
...
htmlhelp_basename = 'PyMoDAQ-Femto documentation'
...
latex_documents = [
    (master_doc, 'PyMoDAQ-Femto.tex', 'PyMoDAQ-Femto Documentation',
