from pypret.material import SellmeierF1, SellmeierF2, BaseMaterial
import numpy as np
...
#KDP
KDP = RefractiveIndexDotInfo(coefficients=[2.259276, 13.00522, 2, 400, 1, 0.01008956, 0, 0.0129426, 1],
                  freq_range=[0.2138e-6, 1.529e-6],
                  name="KDP", long_name="Potassium dihydrogen phosphate")

#ADP
ADP = RefractiveIndexDotInfo(coefficients=[2.302842, 15.102464, 2, 400, 1, 0.011125165, 0, 0.01325366, 1],
                  freq_range=[0.2138e-6, 1.529e-6],
                  name="ADP", long_name="Ammonium dihydrogen phosphate")